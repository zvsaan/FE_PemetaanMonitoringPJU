...
import FotoheroTentangKami from 'assets/images/hero/hero/herotentangkami.jpg';
      ...
      <div className="relative z-10 flex flex-col items-start justify-center h-full text-white mt-7 lg:px-28 px-5">
        ...
        <div className="max-w-lg">
          ...
          <p className="mt-4 text-lg">
            Perusahaan pertama di Indonesia yang menangani masalah PJU melalui skema KPBU
          </p>
        </div>
      </div>
    </section>
